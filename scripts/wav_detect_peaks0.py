...
# Load the audio file
y, sr = librosa.load("VID20250326172717.wav", duration = 20)
...
# Peak picking
peaks = librosa.util.peak_pick(onset_env, pre_max=3, post_max=3, pre_avg=5, post_avg=5, delta=0.3, wait=10)
peak_times = times[peaks]

# Save peak times to CSV
with open("bwv1006_audio_peak_times.csv", "w") as f:
    writer = csv.writer(f)
